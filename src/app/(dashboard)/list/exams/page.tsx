import FormContainer from "@/components/FormContainer"; // 👈 MODIFIÉ : On importe FormContainer
  ...
  return (
    <tr key={item.id} className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLight">
      ...
      <td className="hidden md:table-cell">
        {new Intl.DateTimeFormat("tr-TR", { timeZone: "Europe/Istanbul" }).format(item.startTime)}
      </td>
      <td>
        <div className="flex items-center gap-2">
          {userRole.role === "admin" || userRole.role === "teacher" ? (
            <>
              {/* MODIFIÉ : Utilisation de FormContainer pour l'édition et suppression */}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {/* MODIFIÉ : Utilisation de FormContainer au lieu de FormModal pour le bouton Créer */}
            {(userRoleData.role === "admin" || userRoleData.role === "teacher") && (
