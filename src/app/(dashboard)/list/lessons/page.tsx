...
const LessonListPage = async ({
  ...
  if (queryParams) {
    for (const [key, value] of Object.entries(queryParams)) {
      if (value !== undefined) {
        switch (key) {
          case "classId": query.classId = parseInt(value); break;
          case "teacherId": query.teacherId = value; break;
          case "search":
            query.OR = [
  ...
  // 1. Récupération des données pour la liste
  ...
  // 2. Récupération des données pour le formulaire (relatedData)
