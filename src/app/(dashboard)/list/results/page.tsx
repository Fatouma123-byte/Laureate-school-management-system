import FormContainer from "@/components/FormContainer"; // ✅ Changé de FormModal à FormContainer
    ...
    <td>
      <div className="flex items-center gap-2">
        {((await role()).role === "admin" ||
          ...
          <>
            {/* ✅ CORRECTION : Remplacement de "lesson" par "result" et passage au FormContainer */}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {/* ✅ CORRECTION : Utilisation de FormContainer à la place de FormModal */}
            {((await role()).role === "admin" ||
              (await role()).role === "teacher") && (
