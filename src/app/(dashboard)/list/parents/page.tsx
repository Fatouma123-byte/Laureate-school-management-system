    ...
    <td>
      <div className="flex items-center gap-2">
        {((await role()).role === "admin" ||
          ...
          <button className="flex items-center w-7 h-7 justify-center rounded-full bg:AmedSk bg-AmedSky">
          <Image src="/edit.png" alt="" width={16} height={16} />
          </button>
          </Link> */}
            {/* <button className="flex items-center w-7 h-7 justify-center rounded-full bg:AmedPurple bg-AmedPurple  hover:bg-red-300">
