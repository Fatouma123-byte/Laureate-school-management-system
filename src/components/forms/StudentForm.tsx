...
const StudentForm = ({
  ...
  // CORRECTION ICI : On nettoie et formate les types avant d'envoyer à Server Action
  const onSubmit = handleSubmit((formData) => {
    console.log("Données brutes du formulaire :", formData);
    
    formAction({
      ...formData,
      classId: parseInt(formData.classId as unknown as string), // Convertit le string HTML en Number Int pour Prisma
      birthday: new Date(formData.birthday), // S'assure que la date est au format Date object
    });
  });
  ...
  const { classes, parents } = relatedData || { classes: [], parents: [] };
    ...
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <InputField
          ...
          name="img"
          defaultValue={data?.img || "https://images.pexels.com/photos/1462630/pexels-photo-1462630.jpeg"}
          register={register}
          error={errors.img}
        />
      </div>
